...
def signup():
    ...
    if request.method == 'POST':
        ...
        link = 'https://PrashantInst.ac.in/portal'
        print(password)
        ...
        if account:
            ...
            payload = {
                ...
                "from": {"email": "Prashant@IBMSmartInternz.com"},
                "content": [
                    {
                        "type": "text/plain",
                        "value": "Dear {} ,  \n Welcome to Prashant University, Here there the details to Login Into your student portal link : {} \n YOUR Username : {} \n  PASSWORD : {}  \n Thank you \n Sincerely\n Office of  Admissions\n Prashant Institute of Technology \n E-Mail: admission@Prashantinst.ac.in ; Website: www.PrashantInst.ac.in" .format( name,link, username, password)
                    }
                ]
            }
            headers = {
...
def marksassign(stdname):
    ...
    output = cos.list_objects(Bucket="studentforprashant")
    output
    l=[]
